            ...
            <form class="form-horizontal" role="form" method="post" action="submit_ticket.php?submit=1" name="form1"
                ...
                <script type="text/javascript">
                    $(document).ready(function(){
                        $("#btn-add-row").on("click",function(){
                            var fila = '<tr> <td class="padding-cero"><input type="number" name="equipos[cantidad][]"></td> <td class="padding-cero"><input type="text" name="equipos[nombre_del_equipo][]"></td> <td class="padding-cero"><input type="text" name="equipos[rango_de_medida][]"></td> <td class="padding-cero"><input type="text" name="equipos[resolucion][]"></td> <td class="padding-cero"><input type="text" name="equipos[marca][]"></td> <td class="padding-cero"><input type="text" name="equipos[modelo][]"></td> <td class="padding-cero"><input type="text" name="equipos[serie][]"></td> <td class="padding-cero"><input type="text" name="equipos[codigo][]"></td> <td class="padding-cero"><select name="equipos[equipo_patron][]"><option value="1">Si</option><option value="0">No</option></select></td> <td class="padding-cero"><input type="text" name="equipos[puntos_calibracion][]"></td> <td class="padding-cero"><button class="btn btn-danger btn-xs" onClick=\'if(confirm("Estas Seguro?")){ $(this).parent().parent().remove();}\' ><span class="glyphicon glyphicon-minus"></span></button></td> </tr>';
                            $("#filas_tablas").append(fila);
                            $(".padding-cero").css("padding",0)
                            $("#filas_tablas td input,#filas_tablas td select").css("width","100%")
                            $("#filas_tablas td select").css("height","23px")
                        });
                        $(".padding-cero").css("padding",0)
                        $("#filas_tablas td input,#filas_tablas td select").css("width","100%")
                        $("#filas_tablas td select").css("height","23px")
                ...
                <table class="table table-bordered">
                    <thead>
                        ...
                        <th>Serie</th>
                        <th>Código</th>
                        <th>Equipo Patrón Si/No</th>
                        <th>Puntos de Calibración</th>
                        <th></th>
                    </thead>
                    <tbody id="filas_tablas">
                        <tr>
                            <td class="padding-cero"><input type="number" name="equipos[cantidad][]"></td>            
                            <td class="padding-cero"><input type="text" name="equipos[nombre_del_equipo][]"></td>            
                            <td class="padding-cero"><input type="text" name="equipos[rango_de_medida][]"></td>            
                            <td class="padding-cero"><input type="text" name="equipos[resolucion][]"></td>            
                            <td class="padding-cero"><input type="text" name="equipos[marca][]"></td>            
                            <td class="padding-cero"><input type="text" name="equipos[modelo][]"></td>            
                            <td class="padding-cero"><input type="text" name="equipos[serie][]"></td>            
                            <td class="padding-cero"><input type="text" name="equipos[codigo][]"></td>            
                            <td class="padding-cero"><select name="equipos[equipo_patron][]"><option value="1">Si</option><option value="0">No</option></select></td>            
                            <td class="padding-cero"><input type="text" name="equipos[puntos_calibracion][]"></td>
                            <td class="padding-cero"><button class="btn btn-danger btn-xs" onClick='if(confirm("Estas Seguro?")){ $(this).parent().parent().remove();}' ><span class="glyphicon glyphicon-minus"></span></button></td>           
                        </tr>
                    </tbody>
                </table>
                <div class="blankSpace"></div>
                    <div align="left" class="h3"><?php echo $hesklang['add_ticket_billing_information']; ?></div>
                    <div class="footerWithBorder"></div>
                    <div class="blankSpace"></div>
                <?php
