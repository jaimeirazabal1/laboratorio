<?php
// Settings file for HESK 2.7.2

// ==> GENERAL

// --> General settings
$hesk_settings['site_title']='Laboratorio Veripet';
$hesk_settings['site_url']='http://localhost/laboratorio';
$hesk_settings['hesk_title']='Veripet Laboratorio';
$hesk_settings['hesk_url']='http://localhost/laboratorio';
$hesk_settings['webmaster_mail']='frankivax@gmail.com';
$hesk_settings['noreply_mail']='recepcion@veripet.com.ec';
$hesk_settings['noreply_name']='Laboratorio Veripet';

// --> Language settings
$hesk_settings['can_sel_lang']=1;
$hesk_settings['language']='Español';
$hesk_settings['languages']=array(
'English' => array('folder'=>'en','hr'=>'------ Reply above this line ------'),
'Español' => array('folder'=>'es','hr'=>'------ Reply above this line ------'),
);

// --> Database settings
$hesk_settings['db_host']='localhost';
$hesk_settings['db_name']='veripet_hesk398';
$hesk_settings['db_user']='root';
$hesk_settings['db_pass']='';
$hesk_settings['db_pfix']='heskbg_';
...
$hesk_settings['secimg_sum']='THP4YQEZYB';
...
$hesk_settings['question_ask']='Which number is higher <b>9</b> or <b>3</b>:';
$hesk_settings['question_ans']='9';
...
$hesk_settings['smtp_host_name']='mail.veripet.com.ec';
$hesk_settings['smtp_host_port']=465;
$hesk_settings['smtp_timeout']=20;
$hesk_settings['smtp_ssl']=1;
$hesk_settings['smtp_tls']=0;
$hesk_settings['smtp_user']='recepcion@veripet.com.ec';
$hesk_settings['smtp_password']='Rcp.2016';
...
// --> Date & Time
$hesk_settings['diff_hours']=10;
$hesk_settings['diff_minutes']=22;
...
#     DO NOT EDIT BELOW     #
#############################
$hesk_settings['hesk_version']='2.7.2';
