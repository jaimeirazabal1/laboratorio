    ...
    <li><i class="fa fa-comment bg-red" data-toggle="tooltip" title="<?php echo $hesklang['original_message']; ?>"></i>
        <div class="timeline-item">
            ...
            <?php
                ...
                $equipos = hesk_dbQuery("SELECT * FROM equipos where trackid = '".$ticket['trackid']."' ");
                $equipo = hesk_dbFetchAssoc($equipos);
                $equipo = unserialize(base64_decode($equipo['data']));
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php for($i=0;$i<count($equipo);$i++):?>
                                    <tr>
                                        <td><?php echo $equipo[$i]['cantidad'] ?></td>
                                        <td><?php echo $equipo[$i]['nombre_del_equipo'] ?></td>
                                        <td><?php echo $equipo[$i]['rango_de_medida'] ?></td>
                                        <td><?php echo $equipo[$i]['resolucion'] ?></td>
                                        <td><?php echo $equipo[$i]['marca'] ?></td>
                                        <td><?php echo $equipo[$i]['modelo'] ?></td>
                                        <td><?php echo $equipo[$i]['serie'] ?></td>
                                        <td><?php echo $equipo[$i]['codigo'] ?></td>
                                        <td>
                                        <?php if ($equipo[$i]['equipo_patron']): ?>
                                            Si
                                            <?php else: ?>
                                            No
                                        <?php endif ?>
                                        </td>
                                        <td><?php echo $equipo[$i]['puntos_calibracion'] ?></td>
                                    </tr>
                                <?php endfor; ?>
                            </tbody>
                        </table>
